				...
				<nav class="py-4">
					...
					<ul class="menu mt-2">
						...
						<li>
							...
							<%if(list1.size()!=0){ %>
								<li><a href="wishlist.jsp">WishList (<%out.print(list1.size()); %>)</a></li>
								<%}	%>
							
								
								<li><a href="customer-registration.jsp">Cart</a></li>
							</ul>
						</li>
						<li>
							<!-- First Tier Drop Down --> <label for="drop-2" class="toggle">Drop
								...
								aria-hidden="true"></span></a> <input type="checkbox" id="drop-2" />
							<ul>
								<li><a href="seller-login.jsp">Profile</a></li>
					...
					<div class="product-shoe-info shoe text-center">
						...
						<div class="item-info-product">
							...
							<div class="product_price">
								...
								<div class="grid-price">
									<span class="money">Add to Cart</span>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="container">
			<div class="test-info text-center">
				...
				<ul class="list-unstyled w3layouts-icons clients">
					<li><a href="#"> <span class="fa fa-star"></span>
					</a></li>
					<li><a href="#"> <span class="fa fa-star"></span>
					</a></li>
					<li><a href="#"> <span class="fa fa-star"></span>
					</a></li>
					<li><a href="#"> <span class="fa fa-star-half-o"></span>
					</a></li>
				</ul>
				<p>
					...
					porttitor mollisar lorem, at molestie arcu pulvinar ut. <span
		...
		<div class="container py-lg-0">
			<div class="row text-center brand-items">
				<div class="col-sm-2 col-3">
					<a href="#"><span class="fa fa-connectdevelop"
